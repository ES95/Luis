...
def endpoint(text,debug=False):
    ...
    for entity in list(u['prediction']['entities'].keys())[:-1]:
        ...
        for i in range(len(u['prediction']['entities']["$instance"][entity])):
            ...
            if "list" in ent or "." in ent or marked_flag:continue ## not printing list entities (exact matches), "."-> prebuilt entities or repeated locator_marked   
